/*
 * Stoatworks Labs - About window data for Amber.
 *
...
{
    inline constexpr auto name = "Amber";
    inline constexpr auto slug = "amber";
    inline constexpr auto hook = "Legacy Flash, playable in Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/amber/guide/";
    inline constexpr auto page = "https://stoatworks-labs.com/software/amber/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/amber";
