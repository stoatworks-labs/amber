...
**[v0.1.2](https://github.com/stoatworks-labs/amber/releases/tag/v0.1.2)** — prebuilt for macOS and Windows. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`amber-0.1.2-macos-universal.dmg`](https://github.com/stoatworks-labs/amber/releases/download/v0.1.2/amber-0.1.2-macos-universal.dmg) | 25 MB |
| Universal (Apple Silicon + Intel) · .zip archive | [`amber-0.1.2-macos-universal.zip`](https://github.com/stoatworks-labs/amber/releases/download/v0.1.2/amber-0.1.2-macos-universal.zip) | 22 MB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .zip archive | [`amber-0.1.2-windows-x86_64.zip`](https://github.com/stoatworks-labs/amber/releases/download/v0.1.2/amber-0.1.2-windows-x86_64.zip) | 6.6 MB |
